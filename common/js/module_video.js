(function () {
  ...
  function ensureStyles(){
    ...
    var css =
      ...
      '.vjs-side-sheet.on{transform:translateX(0);visibility:visible;}' +
      /* ✅ 수정된 부분 끝 */
      ...
      /* 항목 */
      '.vjs-sheet-item{position:relative;margin:4px 6px 4px 6px;padding:6px 8px 8px 14px;cursor:pointer;color:#222;border-radius:6px;}' +
